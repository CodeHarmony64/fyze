...
public class Recommendation extends BaseModel {
	...
	// TODO: Update it to lazy loading. It will require us to separate the DTOs from
	// models otherwise Jackson will fail to deserialize the hibernate proxy objects
	@Setter(AccessLevel.NONE)
	@ManyToOne(fetch = FetchType.EAGER)
